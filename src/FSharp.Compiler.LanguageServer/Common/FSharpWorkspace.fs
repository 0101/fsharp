...
type FSharpWorkspace() =
    ...
    member _.AddProject(projectConfig: ProjectConfig, sourceFilePaths: string seq) =
        ...
        depGraph.Transact(fun depGraph ->
            ...
            depGraph
                ...
                .AddProjectConfig(
                    projectIdentifier,
                    (fun refsOnDisk -> projectConfig.With (refsOnDisk |> Seq.toList))
                )
            ...
            let dependentProjectIds = depGraph.GetProjectsThatReference projectIdentifier.OutputFileName
    ...
    member this.AddProject(projectFileName, outputFileName, sourceFiles, referencesOnDisk, otherOptions) =
        ...
        let projectConfig = ProjectConfig(projectFileName, Some outputFileName, referencesOnDisk, otherOptions)
